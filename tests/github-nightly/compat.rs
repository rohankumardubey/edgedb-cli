...
// 1-beta3
#[test_case("edbtest_bionic", &dock_ubuntu("bionic"), "--version=1-beta3")]
#[test_case("edbtest_xenial", &dock_ubuntu("xenial"), "--version=1-beta3")]
#[test_case("edbtest_centos8", &dock_centos(8), "--version=1-beta3")]
#[test_case("edbtest_buster", &dock_debian("buster"), "--version=1-beta3")]
#[test_case("edbtest_stretch", &dock_debian("stretch"), "--version=1-beta3")]
#[test_case("edbtest_focal", &dock_ubuntu("focal"), "--version=1-beta3")]
// nightly
